      ...
      <li class="bg-white w-1/2 mx-auto my-4 shadow-lg flex justify-between p-8 rounded " v-for="portfolio in portfolios" :key="portfolio.name">
        ...
        <div class="flex items-center w-1/3">
          ...
          <button @click="toggleLike(portfolio)">
            ...
            <svg :ref="portfolio._id" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
...
export default {
  ...
  mounted() {
    this.getPortfolios()
    this.$root.$on('portfolioAdded', portfolio => {
      console.log('portfolio from event', portfolio)
